...
<a href="#" class="alert-link">Update Driver</a>
</div>
...
<div style="height: 680px; max-width: 500px; background-color: rgb(171, 240, 217); margin-top: 20px; margin-left: 420px; border:2px solid blue; border-radius: 20px;">
    <form:form action="/CabBookingApplication/driver/update" modelAttribute="driver" method="post" style="max-height: 300px; max-width: 400px; margin-left: 50px;">
        <div class="mb-2">
          <input type="hidden" class="form-control" id="driverId" name="driverId" value="${driver.driverId}">
        </div>
        <div class="mb-2">
          <label for="username" class="form-label">Driver Name</label>
          <input type="text" class="form-control" id="username" name="username" value="${driver.username}">
        </div>
        <div class="mb-2">
        ...
        <div class="mb-2">
            <label for="mobileNumber" class="form-label">Driver Mobile</label>
        ...
        <div class="mb-2">
            ...
            <input type="text" class="form-control" id="licenceNo" name="licenceNo" value="${driver.licenceNo}">
        </div>
      <!--   <div class="mb-2">
            <label for="dcab" class="form-label">Cab ID</label>
            <input type="text" class="form-control" id="dcab" name="dcab" value="xyz123">
        </div>-->
        <div class="mb-2">
            <label for="rating" class="form-label">Driver Rating</label>
            <input type="number" class="form-control" id="rating" name="rating" value="${driver.rating}">
        </div>
        <div class="mb-2">
            <label for="password" class="form-label">Password</label>
            <input type="password" class="form-control" id="password" name="password" value="${driver.password}">
        </div>
