...
<a href="#" class="alert-link">Add New Cab</a>
</div>
...
<div style="height: 200px; max-width: 500px; background-color: rgb(171, 240, 217); margin-top: 20px; margin-left: 420px; border:2px solid blue; border-radius: 20px;">
    <form:form action="add" method="post" modelAttribute="cab" style="max-height: 300px; max-width: 400px; margin-left: 50px;">
        <div class="mb-2">
        ...
        <button type="submit" class="btn btn-success" style="margin-left: 160px;">Add Cab</button>
    </form:form>
</div>
