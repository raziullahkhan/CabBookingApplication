  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/CabBookingApplication/cab/viewcablist">View Cabs</a>
        </li>
        <li class="nav-item">
...
<h3 style="text-align: center; margin-top: 30px;">Update Details</h3>
...
<div style="height: 450px; max-width: 500px; background-color: rgb(171, 240, 217); margin-top: 20px; margin-left: 420px; border:2px solid blue; border-radius: 20px;">
    <form:form action="/CabBookingApplication/customer/update" method="post" modelAttribute="customer" style="max-height: 300px; max-width: 400px; margin-left: 50px;">
    	<div class="mb-2">
          <input type="hidden" class="form-control" id="customerId" name="customerId" value="${customer.customerId}">
        </div>
        <div class="mb-2">
        ...
        <div class="mb-2">
            ...
            <input type="tel" class="form-control" id="mobileNumber" name="mobileNumber" value="${customer.mobileNumber}">
        </div>
        <div class="mb-2">
